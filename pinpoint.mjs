...
export default class Pinpoint {
    /**
     * The parent of the feedback targets.
     *
     * @type {HTMLElement}
     */
    #parent
    ...
    /**
     * The CSS class applied to the parent of the feedback
     * targets when you start listening for feedback.
     *
     * @type {string}
     */
    ...
    /**
     * The CSS class used by feedback targets.
     *
     * @type {string} 
     */
    ...
    /**
     * This event listener is triggered in the capture phase
     * when a feedback target is clicked.
     *
     * @type {Function} 
     */
    #captureListener
    ...
    /**
     * Event listeners mapped to feedback targets. The event
     * listener is called when the click event bubbles up to the
     * target.
     *
     * @type {{[target: Node]: Function}?} 
     */
    #bubblingListeners

    /** 
     * The list of feedback targets
     * 
     * @type {NodeList?}
     */
    #targets
    ...
    /**
     * True when listening for clicks on feedback targets.
     *
     * @type {boolean} 
     */
    #listening = false
    ...
    /**
     * Starts listening for feedback. When a feedback target is
     * clicked the given callback `cb` is called with the target.
     * Call `stopListening()` once done.
     *
     * @param {Function?} cb The callback function
     */
    listen(cb) {
        /**
         * Callback called during the capture phase of the
         * pointer event.
         *
    ...
    /**
     * Returns the CSS class added to the feedback parent when we
     * start listening for feedback.
     *
     * @returns {string}
     */
    enabledClass() {
        this.#assert(typeof this.#enabledClass == 'string', 'CSS class')
